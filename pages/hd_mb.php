...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Thông tin hóa đơn</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-3">
                    <form method="POST">
                                <label>Chọn hóa đơn muốn xem</label>
                                <select name ='idhd' id='idhd' class="form-control">
                                    ...
                                    <?php
                                        for($i = 0; $i < count($result); $i++){
                                            $idhd = htmlentities($result[$i]['hoadon_ID']) ;
                                            
                                            echo '<option value='.$idhd.'>Hóa đơn '.$idhd.'</option>';
                ...
                <div class="col-lg-9">
                    <div class="panel panel-default">
                        ...
                        <div class="table-responsive">
                            <table name='bhdmb' id='bhdmb' class='table table-striped table-bordered table-hover''>
